...
class Match: 
    def __init__(self, id: str): 
        ...
        self.team_a = self.Team_A(self.id, team_a, team_a_score) 
        self.team_b = self.Team_B(self.id, team_b, team_b_score) 

    class Team_A: 
        def __init__(self, match_id: str, name: str, score: str): 
            self.name = name 
            self.score = score 
